...
public class String12 {
	public static void main(String[] args) {
		...
		System.out.println(string12.solution(str, count));
	}
	...
	public String solution(String str, int count) {
		...
		for(int i = 0; i < (str.length()/7); i++) {
			String temp = str.substring(startIndex, startIndex + 7);
			char target = (char)Integer.parseInt(temp, 2); // 2진수를 10진수로 변환한뒤 아스키코드로 변환.
